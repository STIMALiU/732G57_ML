...
\begin{frame}{Neurala nätverk: exempel }
  \begin{itemize}
    \item Exempel i R med regression: \href{https://raw.githubusercontent.com/STIMALiU/732G57_ML/master/lectures/lecture7/keras_reg_lecture.R}{länk}
    \item Tensorflow playground: \href{https://playground.tensorflow.org/}{länk}
  \end{itemize}
\end{frame}
