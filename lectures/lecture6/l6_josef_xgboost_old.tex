...
\begin{frame}{Kostandsfunktion och additiv modell}
  \begin{itemize}
    \item XGBoost bygger upp sin modell genom att successivt lägga till nya beslutsträd.
    \item Varje träd försöker förbättra modellens prediktioner genom att fokusera på de observationer där tidigare träd gjort fel.
    \item Den totala modellen är en summa av alla tidigare träd – en additiv sekvens.
    \item Objektfunktionen balanserar två mål: att minimera fel i prediktionerna och att hålla modellen enkel.
    \item Regularisering ingår i objektfunktionen för att undvika överanpassning.
  \end{itemize}
\end{frame}
...
\begin{frame}{Grundläggande idéer inom XGBoost}
  \begin{itemize}
    ...
    \item Träden byggs med hjälp av en objektfunktion som kombinerar förlust och modellkomplexitet.
...
\begin{frame}{Taylor-expansion av en funktion}
  ...
  \begin{itemize}
    ...
    \item För en tillräckligt slät funktion kan vi skriva:
  \end{itemize}
  ...
  \begin{itemize}
    \item I XGBoost används en andra ordningens Taylor-expansion för att approximera objektfunktionen.
...
\begin{frame}{Första steg mot härledning av Gain}
  \textbf{Taylor-expansion:}
  \begin{itemize}
    \item En Taylor-expansion approximerar en funktion med hjälp av dess derivator runt en punkt.
    \item I XGBoost används en andra ordningens Taylor-expansion för att approximera objektfunktionen.
  \end{itemize}

  \vspace{0.1cm}
  \textbf{Approximerad objektfunktion:}
  \begin{equation*}
...
\begin{frame}{Skattning av lövvikter via Taylor-expansion}
  \textbf{Utgångspunkt:}
  \begin{itemize}
    \item Vi approximerar objektfunktionen med en andra ordningens Taylor-expansion.
    \item För varje löv i trädet summerar vi gradienter och hessianer för de observationer som hamnar där.
  \end{itemize}

  \textbf{Approximerad objektfunktion för ett löv:}
  \begin{equation*}
  ...
  \begin{equation*}
    w^* = -\frac{G}{H + \lambda}
  \end{equation*}
  Detta är den vikt som minimerar den approximativa objektfunktionen för lövet.
\end{frame}
...
\begin{frame}{Översikt av XGBoost-algoritmen}
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \item Optimera varje split med hjälp av en objektfunktion som inkluderar regularisering.
...
\begin{frame}{Regulariseringens roll i XGBoost}
  \begin{itemize}
    ...
    \item I XGBoost införs regularisering direkt i objektfunktionen, vilket påverkar hur träd byggs.
    \item Två typer av regularisering används:
    \begin{itemize}
      \item \textbf{L2-penalitet} på lövvikterna – straffar stora värden och gör modellen mer stabil.
