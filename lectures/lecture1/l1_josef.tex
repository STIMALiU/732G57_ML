...
\begin{frame}{Introduktion - Kursupplägg}
    \begin{itemize}
        ...
        \item Ny kurs! Ersätter 732G12 Data-Mining
...
\begin{frame}{Introduktion - Kursutvärdering 2023}
    \begin{itemize}
        \item Antal respondenter: 20
        \item Antal svar: 13 ($65\%$)
        \item Helhetsbetyg: $4,62$
        \item Förändringar till detta år:
        \begin{itemize}
            \item Ny kurs 2025
            \begin{itemize}
                \item 1-2 nya föreläsningar
                \item Ev mindre förändingar på labbar/föreläsningar/projekt
            \end{itemize}
