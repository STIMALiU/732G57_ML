0\documentclass[10pt,english]{beamer}
...
\begin{frame}{Stegfunktion}
    ...
    \only<2>{
    - Vi testar 5 områden jämt fördelade över $x$.
    \includegraphics[width = \textwidth]{figs/nonLinWithSteps5.png}
    }
    \only<3>{
    - Vi testar 10 områden jämt fördelade över $x$.
...
\begin{frame}{Naturliga splines - Exempel}
    ...
    \uncover<2->{Lägger till Naturliga splines med samma knutar. (Röd linje)}

    \uncover<3->{Lägger till nya knutar i $0.5$ och $4.5$ och kör naturliga splines. (Grön linje)}
