...
\rhead{
Maskininlärning för statistiker 732G57 \\ HT2026}
...
\end{itemize}
Om ni använder knitr med Rmarkdown/latex/lyx, då rekomenderas det att ni har seprata R-filer där ni har era anayser, och att ni sen bara läser in lämpliga resultat i er rapport-fil. Så man inte måste köra om alla skattningar etc varje gånger som man ska kompliera sin rapport-fil. 
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Vilken variabel är er responsvariabel? Ange om ni arbeter med klassificering eller regression. Vid klassificering: Undersök klassbalansen för klasserna.
    ...
    \item Reflektion kring generativ AI och lärande
    \begin{itemize}
      \item Se till att läsa sektion \ref{sec:genAI} om generativ AI innan ni gör denna del.
      \item Skriv kort om hur generativ AI har använts så här långt i kursen i förhållande till er egen inlärning. 
      Hur har det påverkat inlärningen? Vad har varit bra/dåligt? Ni ska skriva en sådan sektion
      \textbf{per gruppmedlem}.
      \item Skriv en kort planering om hur ni som grupp planerar att använda generativ AI under projektet.
    \end{itemize}
\end{itemize}
Inlämningen ska vara en pdf-fil som är 2-4 sidor lång. Syftet är att ni ska välja data
och komma igång med inledande datahantering, börja fundera över frågeställningen 
och reflektera kring generativ AI i projektet.
Det är ok att återanvända hela eller delar av denna inlämning till den slutgiltiga rapporten om man vill.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        att andra som läser kursen kan förstå grunderna i metoden. Undvik att förklaringen tar lång tid.
        \item Förklara kort vilka metoder/modeller som ni har valt. Förklara kort varför metoderna valdes. \textbf{Förklara er
    ...
    \item Presentera på slutet hur ni har använt generativ AI i projektet, och resonera kring det i relation till er inlärning. Ha minst en slide om det.
    \item Se till att hålla tiden.
\end{itemize}

Ladda upp era slides (som pdf) för presentationen på samarbetsytan i kursrummet \textbf{innan} seminariet.
...
\begin{itemize}
    ...
    \begin{itemize}
      \item Det är \textbf{inte ok} bara säga något i stil med "allt var bra gjort". 
      Försök att (konstruktuvt) kritisera arbetet. Det är ok att kritisera delar som ni "håller med om" (detta kan man göra för att testa att de förstår sitt arbete).
      ...
      \item \textbf{Ni måste ha minst två frågor som kritiserar gruppens metod, och som kräver att respondenterna utvecklar sitt resonemang.}
      \item Börja med de viktigaste/största frågorna när ni opponerar.
      \item Svara inte själva på era frågor, utan ge respondenterna tid att svara.
...
\begin{itemize}
    ...
    \item Inte för "enkelt": Tumregel, minst 3000 observationer eller minst förklarande 50 variabler. Ni måste har minst 4 förklarande variabler som är numeriska eller heltalsvärda
    \footnote{Notera: Heltalsvärda, ej kategoriska variabler som kodas med heltal.}. Fråga om ni är osäkra.
    \item När ni hittat ett datamaterial, skriv upp det i dokumentet. Fråga lärare om ni är osäkra på valet.
    \item Problemet ska vara inom \textbf{övervakad inlärning} (kan vara antingen regression eller klassificering).
    \item Ni får \textbf{inte} ta något datamaterial som användes på projektet tidigare år, här finns de listade: \href{https://liuonline.sharepoint.com/:f:/r/sites/Lisam_732G57_2026HT_6E/CourseDocuments/projekt%20-%20datamaterial%20fr%C3%A5n%20tidigare%20%C3%A5r?d=w8b404f3e3d154c7bb8f6dcf4c7fe0ca1&csf=1&web=1&e=ZAVZuT}{länk}
\end{itemize}
...
\begin{itemize}
    \item Generellt: skriv mer allmänt hur ni använde generativ AI i arbetet
    \item Sektion per sektion: För varje sektion så ska ni ange på vilket sätt generativ AI användes, och övegripande förklara arbetesprocessen i relation till generativ AI.
    \item Återkoppla kort till den planering som ni gjorde kring generiv AI i Datainlämningen.
    \item Skriv en kort reflektion kring hur generativ AI påverkat er inlärning i 
    förhållade till kursens lärandemål, se kursplanen: \href{https://studieinfo.liu.se/kurs/732g57#syllabus}{länk}.
\end{itemize}

På \textbf{presentaitonen} så ska ni kortfattat berätta hur ni har använt generativ AI och göra en reflektion kring detta i relation till ert lärande.
\newline
\newline
Ni behöver inte redovisa varje prompt/anrop som ni gjort till en generativ AI, 
utan beskriv mer övergripande vad ni har gjort. Fokusera på arbetsprocessen. Om ni använder kod från generativ AI,
...
\newline
\newline
Alla gruppdeltagare ska vara beredda att muntligen förklara alla delar av ert arbete, för att visa att ni har förståelse för och kunskap om det som ni har gjort i arbetet. 
Vid behov kan ni bli kallade till extra möte med lärare för att muntligen diskutera ert arbete.
\newline
\newline
\textbf{Se till att använda generativ AI ansvarsfullt.}
