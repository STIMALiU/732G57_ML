...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Vilken variabel är er responsvariabel? Vid klassificering: Undersök klassbalansen för klasserna.
...
\end{itemize}
Inlämningen ska vara en pdf-fil som är 2-3 sidor lång. Syftet är att ni ska välja data och komma igång med inledande datahantering, och börja fundera över frågeställningen. Det är ok att återanvända hela eller delar av denna inlämning till den slutgiltiga rapporten om man vill.
...
På \textbf{presentaitonen} så ska ni berätta hur ni har använt generativ AI och göra en reflektion kring detta i relation till ert lärande.
\newline
\newline
